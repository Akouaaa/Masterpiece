...
if(isset($_POST['submit']))
  {
	...
	if ($_POST['dateexpense'] <= date('m/d/y')) {
		echo "<script>alert('Désolé, nous ne voyons pas dans le futur!');</script>";
		die();
	} else {
...
if($query){
echo "<script>alert('La dépense à été ajouté');</script>";
echo "<script>window.location.href='manage-expense.php'</script>";
} else {
echo "<script>alert('Veuillez reésayer');</script>";
...
<head>
	...
	<title>Compte facile || Ajouter une dépense</title>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Dépenses</div>
