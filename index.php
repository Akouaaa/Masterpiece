...
<head>
	...
	<title>Compte facile- Connexion</title>
    ...
    echo $msg;
					...
					<form role="form" action="" method="post" id="" name="login">
						<fieldset>
							...
							<div class="checkbox">
								<button type="submit" value="login" name="login" class="btn btn-primary">Connexion</button><span style="padding-left:250px">
								<a href="register.php" class="btn btn-primary">S'inscrire</a></span>
							</div>
							</fieldset>
					</form>
				</div>
